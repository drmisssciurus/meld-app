      ...
      <div className={styles.policyWrapper}>
        ...
        <div className={styles.pointsWrapper}>
          <div className={styles.points}>
            ...
            <p>
              Meld is a “no-code” custom video analytics platform that allows
              you to deliver new solutions easily with drag and drop tools and
              pre-built analytic building blocks. Meld works with existing
              cameras and video management systems, and once video sources are
              connected, enables you to build and deploy your own customer video
              processing pipelines using Meld, third party, or your own video
              analytics models.
            </p>
          </div>
          ...
          <div className={styles.points}>
            ...
            <p>
              Meld may offer “trial” versions or features of the Service (each,
              a “Trial Service”). Meld will determine, at its sole discretion,
              the availability, duration (the “Trial Period”), features, and
              components of each Trial Service. ANY TRIAL SERVICE IS PROVIDED
              “AS IS” WITHOUT ANY WARRANTIES. Notwithstanding anything to the
              contrary in these Terms, in no event will Meld be liable to you or
              any third party for any damages or liability related to, arising
              out of, or caused by any Trial Service and/or any modification,
              suspension, or termination thereof. Meld at its sole discretion
              shall determine whether or not to continue to offer any Trial
              Service, and may cease offering any Trial Service at any time.
              Upon completion of a Trial Period, you may lose access to the
              applicable Trial Service. Any production candidate or
              non-production version of the Service will be considered a Trial
              Service. Except as expressly provided in this Section 2, these
              Terms govern your use of the Trial Service as part of the Service.
            </p>
          </div>
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              to check our website [lumeo.com] periodically for current
            ...
            <p>
              ...
              (“Subscription Service”). If you activate a Subscription Service,
              you authorize Meld or its third party payment processors to
              ...
              sums. The “Subscription Billing Date” is the date when you
              ...
              (“Subscription Fees”). Unless earlier terminated in accordance
              with these Terms, the Subscription Service will continue for the
              initial term specified on [link to subscription page] (“Initial
              Subscription Term”) and will automatically renew for successive
              terms (each, a “Renewal Term” and, together with the Initial
              Subscription Term, the “Subscription Service Term”) unless you
              provide Meld with written notice of non-renewal of the
              Subscription Service at least 30 days prior to the end of the
              Initial Subscription Term or then-current Renewal Term, as
              applicable. You may cancel the Subscription Service by contacting
              us at: info@lumeo.com. Meld may cancel your Subscription Service
              for any cause or no cause, with or without notice. All
              Subscription Fees paid by you are non-refundable and are
              considered up-front payments for the Subscription Service;
              provided that, in the event Meld terminates your Subscription
              Service without cause, Meld will refund you a pro-rata portion of
              any unused Subscription Fees paid by you. Meld or its third party
              payment processor will bill the periodic Subscription Fee to the
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              and use the Service for your business purposes, including the
              right to use the Service in providing your own services to your
              customers.
            </p>
            <p>
              ...
              use the Service; use the Service provide services to third parties
              (e.g., as a service bureau); use the Service for any benchmarking
              activity or in connection with the development of a competitive
              product; circumvent or disable any security or other technological
              features or measures of the Service or use the Service in a manner
              that Meld reasonably believes poses a threat to the security of
            ...
            <p>
              ...
              to the Service (“Feedback”), then you hereby grant Meld an
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              provided by Meld are protected by intellectual property and other
              laws. All Materials included in the Service are the property of
              Meld or its third party licensors. Except as expressly authorized
              by Meld, you may not make use of the Materials. Meld reserves all
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              Party Components”). Although the Service is provided to you
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              other types of works (“Customer Materials”). You retain any
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              POLICY (lumeo.com/legal/aup), BY USING THE SERVICE YOU AGREE NOT
              TO:
            </p>
            <ul>
              <li>
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              customer service at info@lumeo.com.
            </p>
            <p>
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              subsidiaries and agents (together, the “Meld Entities”) from and
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              [lumeo.com/privacy] carefully for information relating to our
            ...
            <p>
              <b>Consent to Electronic Communications.</b> By using the Service,
            ...
            <p>
              ...
              located at 66 Franklin Street, Suite 300, Oakland, CA 94607. You
              may contact us by sending correspondence to that address or by
              emailing us at info@lumeo.com.
            </p>
            <p>
