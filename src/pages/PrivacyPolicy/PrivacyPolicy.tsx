    ...
    <div className="container">
      <div className={styles.policyWrapper}>
        ...
        <p className={styles.description}>
          ...
          Landmark Detector (MELD/LM) website. It describes how the our team
          (“We,” “Us,” or “Our”) handles all personal information and related
          data (“Personal Information”) that you (“You,” “Your,” or “User”)
          share with us or that we collect from you through your use of our
          website (“Website”).
        </p>
        <div className={styles.pointsWrapper}>
          <div className={styles.points}>
            ...
            <p>
              ...
              review this Policy in full. By providing Personal Information to
              us and accessing or using our website, you consent to the
          ...
          <div className={styles.points}>
            ...
            <p>
              ...
              will be deleted from our servers within 24 hours and not be used
              for any purpose.
            </p>
          </div>
          <div className={styles.points}>
            ...
            <ul>
              <li>
                To process uploaded videos and deliver results efficiently.
              </li>
          ...
          <div className={styles.points}>
            <h3>Use of Data</h3>
            <p>
              The uploaded videos, CSV files, metadata, comments, file names,
              and associated inputs may be used to train or improve our models
              and may be shared in datasets. All rights to these processed data
              remain with us. If your contributions are substantial and you wish
              to be acknowledged, please let us know so we can credit your work.
            </p>
          </div>
          <div className={styles.points}>
